...
export async function generateMetadata({
  ...
  if (params.img_description) {
    description = decodeURIComponent(params.img_description);
  }
  ...
  return {
    ...
    alternates: {
      canonical: `${process.env.WEB_BASE_URI}/wallpaper/${params.img_description}/${params.uuid}`,
    },
  };
}
          ...
          <div className="mx-auto w-full max-w-7xl px-5 py-4 md:px-10 md:py-12">
            <div className="flex flex-col items-center">
              <div className="mb-8 text-center md:mb-12 lg:mb-16">
                ...
                <h2>
                  <a
                    href={`/download/${params.img_description}/${params.uuid}`}
                  >
              ...
              <div className="mb-8 grid w-full grid-cols-1 md:mb-12 md:grid-cols-3 md:gap-4 lg:mb-16">
                {random_wallpapers &&
                  random_wallpapers.map((wallpaper: Wallpaper, idx: number) => {
                    return (
                      <a
                        href={`/wallpaper/${wallpaper.img_description}/${wallpaper.uuid}`}
